...
<div class="calendar-section">
    ...
    <p>Fecha Final   : <input type="date" class="end-date" id="datepicker" autofocus step="1" min="2000-12-1" max="<?php echo date("Y-m-d"); ?>" value="<?php echo date("Y-m-d");?>" required></p>
