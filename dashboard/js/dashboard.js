            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    dashboard.append(
                        ...
                        '</tr>' +
                        '<tr>' +
                        '<td>' + number_format(result2['page_insights'].page_impressions, 0, ',', '.') + '</td>' +
                        '<td>' + number_format(result2['page_insights'].page_post_engagements, 0, ',', '.') + '</td>' +
                        '<td>' + number_format(result2['page_insights'].page_fans, 0, ',', '.') + '</td>' +
                        '</tr>' +
                        '<tr>' +
                        ...
                        '</tr>' +
                        '<tr>' +
                        '<td>' + number_format(result2['page_insights'].total_new_likes, 0, ',', '.') + '</td>' +
                        '<td>' + number_format(result2['page_insights'].page_views_total, 0, ',', '.') + '</td>' +
                        '<td>' + number_format(result2['page_insights'].page_posts_impressions, 0, ',', '.') + '</td>' +
                        '</tr>' +
                        '</table>' +
                        '</div>'
                    );
                    ...
                    dashboard.append(
                        ...
                        '</tr>' +
                        '<tr>' +
                        '<td>' + number_format(result2['ad_insights'].total_clicks, 0, ',', '.') + '</td>' +
                        '<td>' + number_format(result2['ad_insights'].total_ctr, 2, ',', '.') + '</td>' +
                        '<td>' + number_format(result2['ad_insights'].total_reach, 0, ',', '.') + '</td>' +
                        '</tr>' +
                        '<tr>' +
                        '<th>Impresiones</th>' +
                        '<th>Gastado</th>' +
                        ...
                        '</tr>' +
                        '<tr>' +
                        '<td>' + number_format(result2['ad_insights'].total_impressions, 0, ',', '.') + '</td>' +
                        '<td>' + number_format(result2['ad_insights'].total_spend, 0, ',', '.') + '</td>' +
                        '<td>' + number_format(result2['ad_insights'].total_cpm, 0, ',', '.') + '</td>' +
                        '</tr>' +
                        '</table' +
                        '</div>');
